...
export default function GlobalError({ error, reset }: ErrorProps) {
  React.useEffect(() => {
    ...
    console.error("Sanctuary Runtime Error Captured:", error);
  }, [error]);
      ...
      <div className="relative max-w-md mx-auto space-y-8">
        ...
        <div className="space-y-3">
          <h1 className="font-heading text-4xl font-light tracking-tight text-[#3A2820] sm:text-5xl">
            A Scientific Barrier Occurred
          </h1>
          <p className="text-sm leading-relaxed text-[#3A2820]/75 max-w-xs mx-auto">
            An unexpected runtime interruption occurred in our skincare system. Rest assured, our clinical team is notified.
          </p>
          {error.digest && (
            <p className="text-[0.62rem] font-mono tracking-widest text-[#3A2820]/40 uppercase">
